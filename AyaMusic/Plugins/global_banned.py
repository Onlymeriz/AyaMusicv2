from AyaMusic import app, SUDOERS, BOT_ID, OWNER
from AyaMusic.AyaUtils.database.gbanned import (get_gbans_count, is_gbanned_user, add_gban_user, add_gban_user, remove_gban_user)
from AyaMusic.AyaUtils.database.sudo import (get_sudoers, add_sudo, remove_sudo)
from AyaMusic.AyaUtils.database.chats import get_served_chats
...
async def chat_watcher_func(_, message):
    ...
    if await is_gbanned_user(userid):
        try:
            ...
            return       
        await message.reply_text(f"{checking} is globally banned by aya music and has been kicked out from chat.\n\n🚫 **reason:** potential spammer and abuser.")
