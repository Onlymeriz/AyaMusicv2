...
from ..AyaUtils.helpers.ytdl import ytdl
from ..AyaUtils.helpers.inline import (play_keyboard, search_markup)
from pyrogram import filters
from pyrogram.types import InlineKeyboardButton, InlineKeyboardMarkup, Message
from sys import version as pyver
from pyrogram import Client, filters
from pyrogram.types import Message
from AyaMusic import app, SUDOERS, OWNER
from ..AyaUtils.helpers.filters import command
from ..AyaUtils.helpers.decorators import errors
from AyaMusic.AyaUtils.database.functions import start_restart_stage
...
async def update(_, message: Message):
    ...
    if str(m[0]) != "A":
        ...
        os.execvp("python3", ["python3", "-m", "AyuMusic"])
    else:
